...
def dealer_hit():
	...
	if dealer_spot <= 5:
		try:
			...
			if dealer_spot == 0:
				# Resize Card
				dealer_image1 = resize_cards(f'src/cards/{dealer_card}.png')
				# Output Card To Screen
				...
				# Resize Card
				dealer_image2 = resize_cards(f'src/cards/{dealer_card}.png')
				# Output Card To Screen
				...
				# Resize Card
				dealer_image3 = resize_cards(f'src/cards/{dealer_card}.png')
				# Output Card To Screen
				...
				# Resize Card
				dealer_image4 = resize_cards(f'src/cards/{dealer_card}.png')
				# Output Card To Screen
				...
				# Resize Card
				dealer_image5 = resize_cards(f'src/cards/{dealer_card}.png')
				# Output Card To Screen
			...
			root.title(f'Blackjack Game - No Cards In Deck')
...
def player_hit():
	...
	if player_spot <= 5:
		try:
			...
			if player_spot == 0:
				# Resize Card
				player_image1 = resize_cards(f'src/cards/{player_card}.png')
				# Output Card To Screen
				...
				# Resize Card
				player_image2 = resize_cards(f'src/cards/{player_card}.png')
				# Output Card To Screen
				...
				# Resize Card
				player_image3 = resize_cards(f'src/cards/{player_card}.png')
				# Output Card To Screen
				...
				# Resize Card
				player_image4 = resize_cards(f'src/cards/{player_card}.png')
				# Output Card To Screen
				...
				# Resize Card
				player_image5 = resize_cards(f'src/cards/{player_card}.png')
				# Output Card To Screen
...
def deal_cards():
	try:
		...
		# Output Card To Screen
		global dealer_image
		dealer_image = resize_cards(f'src/cards/{card}.png')
		dealer_label_1.config(image=dealer_image)
		dealer_label_2.config(text=card)
		...
		# Output Card To Screen
		global player_image
		player_image = resize_cards(f'src/cards/{card}.png')
		player_label_1.config(image=player_image)
		player_label_2.config(text=card)
